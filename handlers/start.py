...
GREETING = (
    "Приветствую! Меня зовут Марга АСТ.\n\n"
    "Я работаю с бизнесом там, где ИИ даёт реальный результат — "
    "не красивые презентации, а изменения, которые чувствуются каждый день.\n\n"
    "Задам несколько вопросов, чтобы понять, можем ли быть по-настоящему "
    "полезны друг другу. Займёт 5–10 минут.\n\n"
    "Для этого нужно Ваше согласие на обработку персональных данных согласно 152-ФЗ."
)
